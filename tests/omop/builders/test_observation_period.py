...
class TestObservationPeriodBuilder:
    def test_all_fields_populated(
        ...
        result = ObservationPeriodBuilder(concepts, row_id_generator).build(create_build_context(patient, PERSON_ID))
    ...
    def test_missing_treatment_start_returns_empty(
        self,
        static_index,
        structural_index,
        row_id_generator,
    ...
    def test_missing_both_end_dates_returns_empty(
        self,
        static_index,
        structural_index,
        row_id_generator,
    ...
    def test_end_date_falls_back_to_last_cycle(
        self,
        static_index,
        structural_index,
        row_id_generator,
    ...
    def test_end_of_treatment_date_preferred_over_last_cycle(
        self,
        static_index,
        structural_index,
        row_id_generator,
    ...
    def test_row_id_is_deterministic(
        ...
        result_a = ObservationPeriodBuilder(concepts, row_id_generator).build(create_build_context(patient, PERSON_ID))
        result_b = ObservationPeriodBuilder(concepts, row_id_generator).build(create_build_context(patient, PERSON_ID))
    ...
    def test_table_name(
        ...
        concepts = ConceptLookupService(static_index, structural_index)
        assert ObservationPeriodBuilder(concepts, row_id_generator).table_name == "observation_period"
