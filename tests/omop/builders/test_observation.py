...
class TestObservationBuilder:
    def test_table_name(
        ...
        assert ObservationBuilder(concepts, row_id_generator).table_name == "observation"
    ...
    def test_empty_patient_returns_empty(
        ...
        result = ObservationBuilder(concepts, row_id_generator).build(create_build_context(patient, PERSON_ID))
...
class TestEvaluableForEfficacy:
    ...
    def test_true_emits_row_with_yes_value(
        self,
        static_index,
        structural_index,
        row_id_generator,
    ...
    def test_false_emits_row_with_no_value(
        self,
        static_index,
        structural_index,
        row_id_generator,
    ...
    def test_yes_no_missing_falls_back_to_zero(
        self,
        static_index,
        structural_index,
        row_id_generator,
    ...
    def test_skipped_when_value_is_none(
        self,
        static_index,
        structural_index,
        row_id_generator,
    ...
    def test_skipped_when_treatment_start_date_missing(
        self,
        static_index,
        structural_index,
        caplog,
...
class TestClinicalBenefit:
    ...
    def test_emits_row_with_yes_for_true(
        self,
        static_index,
        structural_index,
        row_id_generator,
    ...
    def test_source_value_encodes_week_for_other_timepoints(
        self,
        static_index,
        structural_index,
        row_id_generator,
    ...
    def test_singleton_absent_returns_empty(
        self,
        static_index,
        structural_index,
        row_id_generator,
    ...
    def test_skipped_when_has_benefit_is_none(
        self,
        static_index,
        structural_index,
        row_id_generator,
    ...
    def test_skipped_when_date_is_none(
        self,
        static_index,
        structural_index,
        caplog,
    ...
    def test_skipped_when_week_is_none(
        self,
        static_index,
        structural_index,
        caplog,
...
class TestEndOfTreatment:
    ...
    def test_completed_status_emits_completion_shape(
        self,
        static_index,
        structural_index,
        row_id_generator,
        ...
        assert row.value_source_value == "Normal completion according to cohort-specific man"  # truncated to 50 chars

    def test_completion_topic_missing_falls_back_to_zero(
        self,
        static_index,
        structural_index,
        row_id_generator,
    ...
    def test_withdrawn_with_mapped_reason_emits_withdrawal_shape(
        self,
        static_index,
        structural_index,
        row_id_generator,
    ):
        static_index[("eot_reason", "disease progression")] = _static(concept_id=1340506, domain_id="observation")
        concepts = ConceptLookupService(static_index, structural_index)
        patient = create_patient(PID, TRIAL)
        patient.end_of_treatment = self._make_eot(
    ...
    def test_withdrawn_with_unmapped_reason_emits_value_zero(
        self,
        static_index,
        structural_index,
        row_id_generator,
    ...
    def test_withdrawal_topic_missing_falls_back_to_zero(
        self,
        static_index,
        structural_index,
        row_id_generator,
    ...
    def test_status_none_returns_empty(
        self,
        static_index,
        structural_index,
        row_id_generator,
...
class TestLostToFollowup:
    ...
    def test_lost_to_followup_true_emits_withdrawal_row(
        self,
        static_index,
        structural_index,
        row_id_generator,
    ...
    def test_topic_concept_missing_falls_back_to_zero(
        self,
        static_index,
        structural_index,
        row_id_generator,
    ...
    def test_reason_concept_missing_falls_back_to_zero(
        self,
        static_index,
        structural_index,
        row_id_generator,
    ...
    def test_lost_to_followup_false_emits_nothing(
        self,
        static_index,
        structural_index,
        row_id_generator,
...
class TestAdverseEventOutcome:
    ...
    def test_mapped_outcome_emits_row(
        self,
        static_index,
        structural_index,
        row_id_generator,
        ...
        result = ObservationBuilder(concepts, row_id_generator).build(ctx)
    ...
    def test_value_static_missing_falls_back_to_zero(
        self,
        static_index,
        structural_index,
        row_id_generator,
    ...
    def test_both_lookups_missing_emits_zero_row_with_raw_value(
        self,
        static_index,
        structural_index,
        row_id_generator,
    ...
    def test_outcome_none_emits_nothing(
        self,
        static_index,
        structural_index,
        row_id_generator,
...
class TestAdverseEventWasSerious:
    ...
    def test_was_serious_true_emits_row_with_fk(
        self,
        static_index,
        structural_index,
        row_id_generator,
    ...
    def test_was_serious_none_emits_nothing(
        self,
        static_index,
        structural_index,
        row_id_generator,
    ...
    def test_no_fk_when_no_condition_row_published(
        self,
        static_index,
        structural_index,
        row_id_generator,
    ...
    def test_no_fk_when_ae_missing_sequence_id(
        self,
        static_index,
        structural_index,
        row_id_generator,
    ...
    def test_raises_when_cdm_field_missing_but_fk_resolvable(
        self,
        static_index,
        structural_index,
        row_id_generator,
        ...
        with pytest.raises(RuntimeError, match="cdm_field"):
            ObservationBuilder(concepts, row_id_generator).build(ctx)


class TestAdverseEventTurnedSerious:
    def test_emits_row_on_turned_serious_date(
        self,
        static_index,
        structural_index,
        row_id_generator,
...
class TestAdverseEventSeverity:
    ...
    def test_falls_back_to_zero_when_grade_unmapped(
        self,
        static_index,
        structural_index,
        row_id_generator,
...
class TestAdverseEventRelatedness:
    ...
    def test_emits_one_row_per_set_treatment_status(
        self,
        static_index,
        structural_index,
        row_id_generator,
    ...
    def test_none_status_emits_no_row(
        self,
        static_index,
        structural_index,
        row_id_generator,
    ...
    def test_value_concept_falls_back_to_zero_when_unmapped(
        self,
        static_index,
        structural_index,
        row_id_generator,
    ...
    def test_treatment_name_none_yields_null_qualifier(
        self,
        static_index,
        structural_index,
        row_id_generator,
...
class TestAdverseEventExpectedness:
    ...
    def test_true_maps_to_expected_concept(
        self,
        static_index,
        structural_index,
        row_id_generator,
    ...
    def test_both_treatments_emit_two_result(
        self,
        static_index,
        structural_index,
        row_id_generator,
...
class TestCombinedSources:
    def test_multi_source_uniqueness_and_determinism(
        self,
        static_index,
        structural_index,
        row_id_generator,
        ...
        result_a = ObservationBuilder(concepts, row_id_generator).build(ctx_a)
        result_b = ObservationBuilder(concepts, row_id_generator).build(ctx_b)
    ...
    def test_multiple_adverse_events_each_independent(
        self,
        static_index,
        structural_index,
        row_id_generator,
...
class TestTreatmentCycleMetadata:
    ...
    @staticmethod
    def _rows(ctx, static_index, structural_index, row_id_generator):
        return ObservationBuilder(ConceptLookupService(static_index, structural_index), row_id_generator).build(ctx).rows

    def test_number_field_links_to_drug_exposure(
        self,
        static_index,
        structural_index,
        row_id_generator,
        ...
        _rows = self._rows(ctx, static_index, structural_index, row_id_generator)
        meta = [r for r in _rows if r.observation_source_value == "number_of_days_tablet_not_taken"]
        assert len(meta) == 1
        row = meta[0]
        assert row.observation_concept_id == 0
    ...
    def test_bool_field_maps_to_yes_no(
        ...
        _rows = self._rows(ctx, static_index, structural_index, row_id_generator)
        meta = [r for r in _rows if r.observation_source_value == "was_dose_administered_to_spec"]
        assert len(meta) == 1
    ...
    def test_text_field_goes_to_value_as_string(
        self,
        static_index,
        structural_index,
        row_id_generator,
        ...
        _rows = self._rows(ctx, static_index, structural_index, row_id_generator)
        meta = [r for r in _rows if r.observation_source_value == "reason_tablet_not_taken"]
        assert len(meta) == 1
        assert meta[0].value_as_string == "patient forgot"
        assert meta[0].observation_event_id == self.DRUG_ROW_ID

    def test_skips_when_no_drug_exposure_published(
        self,
        static_index,
        structural_index,
        row_id_generator,
    ...
    def test_multiple_fields_emit_one_row_each(
        self,
        static_index,
        structural_index,
        row_id_generator,
        ...
        _rows = self._rows(ctx, static_index, structural_index, row_id_generator)
        sources = {r.observation_source_value for r in _rows}
        assert sources == {
            "number_of_days_tablet_not_taken",
            "reason_tablet_not_taken",
            "was_dose_administered_to_spec",
        }
        assert len({r.observation_id for r in _rows}) == 3  # distinct PKs
